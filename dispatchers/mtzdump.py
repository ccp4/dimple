...
#
"""CCP4 dispatcher for the binary 'mtzdump'"""
...
class Dispatcher:
    """A class to handle dispatch to 'mtzdump'"""
    ...
    def __init__(self, communicate = True):
        ...
        self.command = os.path.join(os.environ["CBIN"], "mtzdump")
    ...
    def get_bin(self):
        """Method to get the path to 'mtzdump'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'mtzdump'"""
    ...
    def monitor(self):
        """
        Method to read output of mtzdump and check if it has finished.
...
if __name__ == "__main__":
    # This dispatcher is being run as a script, so go ahead and execute mtzdump
