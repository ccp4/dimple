...
#
"""CCP4 dispatcher for the binary 'unique'"""
...
class Dispatcher:
    """A class to handle dispatch to 'unique'"""
    ...
    def __init__(self, communicate = True):
        ...
        self.command = os.path.join(os.environ["CBIN"], "unique")
    ...
    def get_bin(self):
        """Method to get the path to 'unique'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'unique'"""
    ...
    def monitor(self):
        """
        Method to read output of unique and check if it has finished.
...
if __name__ == "__main__":
    # This dispatcher is being run as a script, so go ahead and execute unique
