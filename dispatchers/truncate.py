...
#
"""CCP4 dispatcher for the binary 'truncate'"""
...
class Dispatcher:
    """A class to handle dispatch to 'truncate'"""
    ...
    def __init__(self, communicate = True):
        ...
        self.command = os.path.join(os.environ["CBIN"], "truncate")
    ...
    def get_bin(self):
        """Method to get the path to 'truncate'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'truncate'"""
    ...
    def monitor(self):
        """
        Method to read output of truncate and check if it has finished.
...
if __name__ == "__main__":
    # This dispatcher is being run as a script, so go ahead and execute truncate
