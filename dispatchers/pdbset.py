...
#
"""CCP4 dispatcher for the binary 'pdbset'"""
...
class Dispatcher:
    """A class to handle dispatch to 'pdbset'"""
    ...
    def __init__(self, communicate = True):
        ...
        self.command = os.path.join(os.environ["CBIN"], "pdbset")
    ...
    def get_bin(self):
        """Method to get the path to 'pdbset'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'pdbset'"""
    ...
    def monitor(self):
        """
        Method to read output of pdbset and check if it has finished.
...
if __name__ == "__main__":
    # This dispatcher is being run as a script, so go ahead and execute pdbset
