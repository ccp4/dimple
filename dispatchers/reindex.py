...
#
"""CCP4 dispatcher for the binary 'reindex'"""
...
class Dispatcher:
    """A class to handle dispatch to 'reindex'"""
    ...
    def __init__(self, communicate = True):
        ...
        self.command = os.path.join(os.environ["CBIN"], "reindex")
    ...
    def get_bin(self):
        """Method to get the path to 'reindex'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'reindex'"""
    ...
    def monitor(self):
        """
        Method to read output of reindex and check if it has finished.
...
if __name__ == "__main__":
    # This dispatcher is being run as a script, so go ahead and execute reindex
