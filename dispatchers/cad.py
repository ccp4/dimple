...
#
"""CCP4 dispatcher for the binary 'cad'"""
...
class Dispatcher:
    """A class to handle dispatch to 'cad'"""
    ...
    def __init__(self, communicate = True):
        ...
        self.command = os.path.join(os.environ["CBIN"], "cad")
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'cad'"""
    ...
    def monitor(self):
        """
        Method to read output of cad and check if it has finished.
...
if __name__ == "__main__":
    # This dispatcher is being run as a script, so go ahead and execute cad
