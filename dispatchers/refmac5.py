...
#
"""CCP4 dispatcher for the binary 'refmac5'"""
...
class Dispatcher:
    """A class to handle dispatch to 'refmac5'"""
    ...
    def __init__(self, communicate = True):
        ...
        self.command = os.path.join(os.environ["CBIN"], "refmac5")
    ...
    def get_bin(self):
        """Method to get the path to 'refmac5'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'refmac5'"""
    ...
    def monitor(self):
        """
        Method to read output of refmac5 and check if it has finished.
...
if __name__ == "__main__":
    # This dispatcher is being run as a script, so go ahead and execute refmac5
