...
#
"""CCP4 dispatcher for the binary 'pointless'"""
...
class Dispatcher:
    """A class to handle dispatch to 'pointless'"""
    ...
    def __init__(self, communicate = True):
        ...
        self.command = os.path.join(os.environ["CBIN"], "pointless")
    ...
    def get_bin(self):
        """Method to get the path to 'pointless'"""
    ...
    def set_keywords(self, kwstring):
        """Method to set keywords to pass to 'pointless'"""
    ...
    def monitor(self):
        """
        Method to read output of pointless and check if it has finished.
...
if __name__ == "__main__":
    # This dispatcher is being run as a script, so go ahead and execute pointless
